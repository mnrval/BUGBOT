...
await this.sendMessage(id, { 
   ...
   contextInfo: { mentions: [participants[0]], externalAdReply: { title: global.wm, body: global.author, mediaType: 1, thumbnailUrl: isAddAction ? welthum : byethum, renderLargerThumbnail: true, sourceUrl: "https://chat.whatsapp.com/FHgxehyvkaiHQJLfZyVuDi" }}})
...
${userTag} Perintah ini hanya dapat digunakan oleh *Owner Bot* !`,
        rowner: `*${emoji.rowner} ᴘᴇʀʜᴀᴛɪᴀɴ ᴏᴡɴᴇʀ*\n
${userTag} Perintah ini hanya dapat digunakan oleh *Owner Utama Bot* !`,
