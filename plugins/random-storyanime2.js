let handler = async (m, { conn, usedPrefix, command }) => {
	try {
		...
		await conn.sendMsg(m.chat, { video: fimgb, caption: `_Random Story Anime2_` }, { quoted: m })
	} catch (e) {
		console.log(e)
		try {
...
handler.menuanime = ['storyanime2']
handler.tagsanime = ['anime','random','premium']
handler.command = /^(storyanime2|storianime2|animestori2|animestory2)$/i
