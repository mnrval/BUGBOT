let handler = async(m, { conn, text, usedPrefix, command }) => {
	...
	try {
		let res = await fetch(`https://api.lolhuman.xyz/api/solidfiles?apikey=${global.lol}&url=${text}`)
		...
		try {
			...
			console.log(e)
			throw `Invalid Solidfile URL / terjadi kesalahan.`
		}
	}
}
