...
const listMessage = {
  text: '\nBerikut adalah daftar apa yang dapat Anda aktifkan dan nonaktifkan',
  footer: fgig,
  title: `≡ Daftar Pilihan`,
...
m.reply(`
✅ *${type}* Se *${isEnable ? 'Dinyalakan' : 'Dinonaktifkan'}* ${isAll ? 'Untuk Bot Ini' : isUser ? '' : 'Untuk Obrolan Ini'}
`.trim()) 

}
handler.help = ['en', 'dis'].map(v => v + 'able2 <option>')
handler.tags = ['group', 'owner']
handler.command = /^((en|dis)able2|(tru|fals)e2|(turn)?(o)n2|ff2|[01])$/i
