...
global.kontak2 = [
[owner[0], await conn.getName(owner[0] + '1239873452@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'rifalmodzyt@gmail.com', true],
[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'rifalbotz@gmail.com', true],
]
...
global.ppkecil = {
            ...
            externalAdReply: {
                ...
                sourceUrl: `https://chat.whatsapp.com/FHgxehyvkaiHQJLfZyVuDi`,
                //previewType: "PHOTO",
                mediaType: 1,
...
global.thumbnailUrl2 = ['https://telegra.ph/file/5017096ec44fe534cedc1.jpg','https://telegra.ph/file/750b9441950f178f90af9.jpg','https://telegra.ph/file/625273ee8385d12b92eee.jpg','https://telegra.ph/file/66cb6fd8cd187ce47e881.jpg','https://telegra.ph/file/b05c80ea35efd322be687.jpg']
...
global.logo = ['https://telegra.ph/file/745bf417e3506e38a4f36.png','https://telegra.ph/file/adbd78ca2772790456b21.jpg','https://telegra.ph/file/aa615dd28794c2711d28c.jpg','https://telegra.ph/file/d12b0ff7295bf3069160d.jpg','https://telegra.ph/file/3a7ed6a8dfd3be1f4a907.jpg']
...
/* Fake Reply */
function Fakes() {
    let Org = pickRandom(["0", "6285611223403", "62889062500517", "62821905322106", "62810119568305", "62812802722861", "62821102790446"])
    ...
    let ftroli = {
        ...
        message: {
            orderMessage: {
                ...
                status: 1,
                surface: 1,
                message: `Time : ${moment.tz("Asia/Makassar").format("HH:mm:ss")}`,
                orderTitle: Sarapan,
                sellerJid: Parti
            }
        }
    ...
    let ftextt = {
        ...
        message: {
            extendedTextMessage: {
                text: Sarapan,
                title: `Time : ${moment.tz("Asia/Makassar").format("HH:mm:ss")}`,
                jpegThumbnail: Thum
            }
        }
    }
    let fliveLoc = {
        ...
        message: {
            liveLocationMessage: {
                caption: Sarapan,
                h: `Time : ${moment.tz("Asia/Makassar").format("HH:mm:ss")}`,
                jpegThumbnail: Thum
            }
        }
    }
        ...
        message: {
            productMessage: {
                product: {
                    ...
                    title: Sarapan,
                    description: `Time : ${moment.tz("Asia/Makassar").format("HH:mm:ss")}`,
                    currencyCode: "USD",
    ...
    let fgif = {
        ...
        message: {
            videoMessage: {
                ...
                seconds: SizeDoc(),
                gifPlayback: true,
                caption: `Time : ${moment.tz("Asia/Makassar").format("HH:mm:ss")}`,
                jpegThumbnail: Thum
            }
        }
    }
